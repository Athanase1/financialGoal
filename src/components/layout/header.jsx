...
export default function Header({ onClick, displayNav }) {
  ...
  return (
    <header className="bg-success">
      <div className="navi">
        <div className=" logo  rounded " onClick={handleClick}>
      ...
      <nav
        className={
          displayNav
            ? "show navbar navbar-expand-lg navbar-light bg-success"
      ...
      >
        <li onClick={onClick}>
          <Link
            to="/"
            className="d-flex flex-row align-items-center fw-bold text-white"
          >
